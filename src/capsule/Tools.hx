...
class Tools {
	...
	public static macro function withSingleton(container:haxe.macro.Expr.ExprOf<Container>, target:haxe.macro.Expr,
	...
	public static macro function withTransient(container:haxe.macro.Expr.ExprOf<Container>, target:haxe.macro.Expr,
			factory:haxe.macro.Expr):haxe.macro.Expr.ExprOf<Container> {
		return macro {
			var container = $container;
